...
class Row {
  ...
  splice(start: any, count: any, ...inserts: any) {
  ...
  set values(value: any) {
    ...
    if (!value) {
      ...
      this._worksheet.eachColumnKey((column: any, key: any) => {
  ...
  set model(value: any) {
    ...
    this._cells = [];
    let previousAddress: any;
    value.cells.forEach((cellModel: any) => {
